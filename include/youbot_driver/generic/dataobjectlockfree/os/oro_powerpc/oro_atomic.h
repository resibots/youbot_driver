...
static inline void isync(void) { __asm__ __volatile__("isync"
                                                      :
                                                      :
                                                      : "memory"); }
...
static __inline__ void oro_atomic_add(oro_atomic_t* v, int n)
{
    ...
    __asm__ __volatile__("1:	lwarx	%0,0,%3		# oro_atomic_add\n\
...
static __inline__ void oro_atomic_sub(int a, oro_atomic_t* v)
{
    ...
    __asm__ __volatile__("1:	lwarx	%0,0,%3		# oro_atomic_sub\n\
	subf	%0,%2,%0\n" PPC405_ERR77(0, % 3) "	stwcx.	%0,0,%3 \n\
	bne-	1b"
                         : "=&r"(t), "=m"(v->counter)
                         : "r"(a), "r"(&v->counter), "m"(v->counter)
...
static __inline__ void oro_atomic_inc(oro_atomic_t* v)
{
    ...
    __asm__ __volatile__("1:	lwarx	%0,0,%2		# oro_atomic_inc\n\
	addic	%0,%0,1\n" PPC405_ERR77(0, % 2) "	stwcx.	%0,0,%2 \n\
	bne-	1b"
                         : "=&r"(t), "=m"(v->counter)
...
static __inline__ void oro_atomic_dec(oro_atomic_t* v)
{
    ...
    __asm__ __volatile__("1:	lwarx	%0,0,%2		# oro_atomic_dec\n\
	addic	%0,%0,-1\n" PPC405_ERR77(0, % 2) "	stwcx.	%0,0,%2\n\
	bne-	1b"
                         : "=&r"(t), "=m"(v->counter)
                         : "r"(&v->counter), "m"(v->counter)
