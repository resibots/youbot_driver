...
{
    __asm__ __volatile__(ORO_LOCK "addl %1,%0"
                         : "=m"(v->counter)
                         : "ir"(i), "m"(v->counter));
}
...
{
    __asm__ __volatile__(ORO_LOCK "subl %1,%0"
                         : "=m"(v->counter)
                         : "ir"(i), "m"(v->counter));
}
...
static __inline__ int oro_atomic_sub_and_test(oro_atomic_t* v, int i)
{
    ...
    __asm__ __volatile__(ORO_LOCK "subl %2,%0; sete %1"
                         : "=m"(v->counter), "=qm"(c)
                         : "ir"(i), "m"(v->counter)
                         : "memory");
    return c;
...
{
    __asm__ __volatile__(ORO_LOCK "incl %0"
                         : "=m"(v->counter)
                         : "m"(v->counter));
}
...
{
    __asm__ __volatile__(ORO_LOCK "decl %0"
                         : "=m"(v->counter)
                         : "m"(v->counter));
}
...
static __inline__ int oro_atomic_dec_and_test(oro_atomic_t* v)
{
    ...
    __asm__ __volatile__(ORO_LOCK "decl %0; sete %1"
                         : "=m"(v->counter), "=qm"(c)
                         : "m"(v->counter)
                         : "memory");
    return c != 0;
...
static __inline__ int oro_atomic_inc_and_test(oro_atomic_t* v)
{
    ...
    __asm__ __volatile__(ORO_LOCK "incl %0; sete %1"
                         : "=m"(v->counter), "=qm"(c)
                         : "m"(v->counter)
                         : "memory");
    return c != 0;
...
static __inline__ int oro_atomic_add_negative(int i, oro_atomic_t* v)
{
    ...
    __asm__ __volatile__(ORO_LOCK "addl %2,%0; sets %1"
                         : "=m"(v->counter), "=qm"(c)
                         : "ir"(i), "m"(v->counter)
                         : "memory");
    return c;
