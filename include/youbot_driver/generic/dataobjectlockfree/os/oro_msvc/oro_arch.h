...
#pragma warning(push)
#pragma warning(disable : 4715) // Disable warning on "specified function can
// potentially not return a value"

template <typename T>
inline T oro_cmpxchg(volatile void* ptr, T old, T _new)
{
    switch (sizeof(T)) {
    case 2:
        return (T)(
            _InterlockedCompareExchange16((short*)ptr, (short)_new, (short)old));
    case 4:
        return (T)(_InterlockedCompareExchange((long*)ptr, (long)_new, (long)old));
    case 8:
        return (T)(_InterlockedCompareExchange64((__int64*)ptr, (__int64)_new,
            (__int64)old));
    }
}
